...
const UsernameMenu = () => {
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger className="flex items-center font-bold px-3 hover:text-green-500 gap-3">
      ...
      <DropdownMenuContent>
        ...
        <DropdownMenuItem>
          <Button
            onClick={() => logout()}
            className="flex flex-1 bg-green-500 hover:bg-green-600 font-bold"
          >
            Log out
          </Button>
        </DropdownMenuItem>
